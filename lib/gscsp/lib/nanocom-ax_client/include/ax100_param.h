...
#define AX100_BEACON_INTERVAL		0x24
#define AX100_BEACON_HOLDOFF		0x28
...
static const param_table_t ax100_config[] = {
		...
		{.name = "bcn_interval", 	.addr = AX100_BEACON_INTERVAL,		.type = PARAM_UINT32, 	.size = sizeof(uint32_t)},
		{.name = "bcn_holdoff", 	.addr = AX100_BEACON_HOLDOFF,		.type = PARAM_UINT32, 	.size = sizeof(uint32_t)},
