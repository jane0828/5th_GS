...
/** Address of mag_rotation: Magnetometer rotation matrix */
#define GS_ADCS_SENSOR_A3200_MAG_ROTATION(idx)                      (   24 + ( 4 * (idx)))  // 0x0018 float
/** Array size of mag_rotation: Magnetometer rotation matrix */
#define GS_ADCS_SENSOR_A3200_MAG_ROTATION_ARRAY_SIZE                     9
/** Address of mag_rot_t: Rotation and translation matrix */
#define GS_ADCS_SENSOR_A3200_MAG_ROT_T(idx)                         (   60 + ( 4 * (idx)))  // 0x003c float
/** Array size of mag_rot_t: Rotation and translation matrix */
...
/** Address of mag_enable: Magnetometer gain calibration value */
#define GS_ADCS_SENSOR_A3200_MAG_ENABLE(idx)                        (  107 + ( 1 * (idx)))  // 0x006b uint8
/** Array size of mag_enable: Magnetometer gain calibration value */
...
/** Address of gyro_enable: Gyro sign */
#define GS_ADCS_SENSOR_A3200_GYRO_ENABLE(idx)                       (  154 + ( 1 * (idx)))  // 0x009a int8
/** Array size of gyro_enable: Gyro sign */
