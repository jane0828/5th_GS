...
#define GS_ADCS_SENSOR_COMMON__FILLER_END_SET(value, value_size) gs_param_set_data(gs_param_table_by_id(GS_ADCS_SENSOR_COMMON_TABLE_ID), GS_ADCS_SENSOR_COMMON__FILLER_END, value, value_size, 0)
/** Set _filler_end (no callback): Filler for alignment */
#define GS_ADCS_SENSOR_COMMON__FILLER_END_SET_NO_CALLBACK(value, value_size) gs_param_set_data(gs_param_table_by_id(GS_ADCS_SENSOR_COMMON_TABLE_ID), GS_ADCS_SENSOR_COMMON__FILLER_END, value, value_size, GS_PARAM_F_NO_CALLBACK)
/** Get _filler_end: Filler for alignment */
#define GS_ADCS_SENSOR_COMMON__FILLER_END_GET(buf, buf_size) gs_param_get_data(gs_param_table_by_id(GS_ADCS_SENSOR_COMMON_TABLE_ID), GS_ADCS_SENSOR_COMMON__FILLER_END, buf, buf_size, 0)
/**@}*/
