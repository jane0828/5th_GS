...
#define GS_ADCS_GNC_COMMON_TABLE_SIZE                    244 // bytes
/** Table rows (count) */
#define GS_ADCS_GNC_COMMON_TABLE_ROWS                    26
...
/** Address of pwm_deadtime: How long the pwm should be quiet for during each run */
