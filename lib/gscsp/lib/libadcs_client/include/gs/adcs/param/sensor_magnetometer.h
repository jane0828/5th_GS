...
/** Address of rotation: Magnetometer rotation matrix */
#define GS_ADCS_SENSOR_MAGNETOMETER_ROTATION(idx)                   (   24 + ( 4 * (idx)))  // 0x0018 float
/** Array size of rotation: Magnetometer rotation matrix */
#define GS_ADCS_SENSOR_MAGNETOMETER_ROTATION_ARRAY_SIZE                  9
/** Address of rot_trans: Rotation and translation matrix */
#define GS_ADCS_SENSOR_MAGNETOMETER_ROT_TRANS(idx)                  (   60 + ( 4 * (idx)))  // 0x003c float
/** Array size of rot_trans: Rotation and translation matrix */
