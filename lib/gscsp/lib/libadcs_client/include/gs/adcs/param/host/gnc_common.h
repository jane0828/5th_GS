...
typedef struct __attribute__ ((packed)) {
    ...
    /** How long the pwm should be quiet for during each run */
...
/** Set pwm_deadtime: How long the pwm should be quiet for during each run */
...
/** Set pwm_deadtime (no callback): How long the pwm should be quiet for during each run */
...
/** Get pwm_deadtime: How long the pwm should be quiet for during each run */
...
/** Get pwm_deadtime (no check - return 0 on failure): How long the pwm should be quiet for during each run */
