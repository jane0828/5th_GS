...
static PyObject* pyftp_download(PyObject* self, PyObject* args)
{
    ...
    file_info_t fi;
    int rc = gs_ftp_download(&settings, local_url, remote_url, size_and_checksum_cb, &fi, 3);
...
static PyObject* pyftp_upload(PyObject* self, PyObject* args)
{
    ...
    file_info_t fi;
    int rc = gs_ftp_upload_force(&settings, local_url, remote_url, size_and_checksum_cb, &fi);
