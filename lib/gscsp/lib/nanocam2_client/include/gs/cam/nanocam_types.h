...
#define NANOCAM_DEFAULT_GATEWAY		5

/* CSP ports */
/* Shared ports */
#define NANOCAM_PORT_RPARAM		7
#define NANOCAM_PORT_FTP		9
/* Specific ports */
...
/* Param persist addresses */
#define NANOCAM_FRAM_TELEM		0x5000 /** Persistent telemetry address */

/* Param filename */
#define NANOCAM_FNO_CONFIG		24 /** First file in RO area */
#define NANOCAM_FNO_CONFIG_DFL		25 /** Second file in RO area */

#define NANOCAM_FNO_IMAGE		1  /** Second file */
#define NANOCAM_FNO_IMAGE_DFL		26 /** Third file in RO area */

#define NANOCAM_FNO_TAG			2  /** Third file in normal area */
#define NANOCAM_FNO_TAG_DFL		27 /* Fourth file in RO area */

/* Param index map */
#define NANOCAM_PARAM_CONFIG		0 /** Global configuration parameters */
#define NANOCAM_PARAM_IMAGE		1 /** Image configuration parameters */
#define NANOCAM_PARAM_SENSOR		2 /** Mapped sensor registers parameters */
#define NANOCAM_PARAM_TAG		3 /** Image tagging parameters */
#define NANOCAM_PARAM_TELEM		4 /** Telemetry parameters */
...
#define NANOCAM_STORE_RAW10		4 /* Store packed RAW output */
