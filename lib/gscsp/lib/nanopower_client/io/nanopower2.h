...
#define EPS_PORT_CONFIG3 25

#define EPS_CONFIG_CMD_RESTORE  1
#define EPS_CONFIG_CMD_CONFIRM  2
#define EPS_CONFIG_CMD_GET      3
#define EPS_CONFIG_CMD_SET      4

#define WDT_GND_MIN_HRS         1       // Minimum wdt gnd is 1 hour
#define WDT_GND_MAX_HRS         192     // Maximum wdt gnd is 8 days = 192 hours

#define WDT_I2C_MIN_SECS_100    5900      // Minimum wdt i2c is 59 seconds
#define WDT_I2C_MAX_SECS_100    8640000   // Maximum wdt i2c is 86400 seconds
...
int eps_config3_get(eps_config3_t * config3);
...
int eps_config3_set(eps_config3_t * config3);
