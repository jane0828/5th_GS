...
def configure_project(bootstrap=False, docker=False):
    ...
    print "Setting up project to use buildtools: " + util.buildtools_root()
...
def cmd_bootstrap(args):
    configure_project(bootstrap=True, docker=args.docker)
...
def get_main_parser():
    ...
    parser.add_argument('-d', '--docker', action='store_true', default=False, help='Bootstrap project to use docker')
    ...
    try:
        import gs.buildtools.jenkins
        gs.buildtools.jenkins.add_cmdline(subparser)
