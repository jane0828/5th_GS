...
// // //         }
// // //         else{
// // //             memcpy(&v.u.roma_noop, payload, sizeof(payuel_roma_ResetCounters_tlm_payload_t));
// // //             return true;
// // //         }
// // //     }
...
// // //         }
// // //         else{
// // //             memcpy(&v.u.roma_noop, payload, sizeof(payuel_roma_CommTest_tlm_payload_t));
// // //             return true;
// // //         }
// // //     }
...
// // //         }
// // //         else{
// // //             memcpy(&v.u.roma_noop, payload, sizeof(payuel_roma_GetSpecificLine_tlm_payload_t));
// // //             return true;
// // //         }
// // //     }
...
// // //         }
// // //         else{
// // //             memcpy(&v.u.roma_noop, payload, sizeof(payuel_roma_GetMultipleLines_tlm_payload_t));
// // //             return true;
// // //         }
// // //     }
...
// // //         }
// // //         else{
// // //             memcpy(&v.u.roma_noop, payload, sizeof(payuel_roma_GetLatestLine_tlm_payload_t));
// // //             return true;
// // //         }
// // //     }
...
// // //         }
// // //         else{
// // //             memcpy(&v.u.roma_noop, payload, sizeof(payuel_roma_GetLatest_N_Lines_tlm_payload_t));
// // //             return true;
// // //         }
// // //     }
...
// // //         }
// // //         else{
// // //             memcpy(&v.u.roma_noop, payload, sizeof(payuel_roma_SetRouteDefault_tlm_payload_t));
// // //             return true;
// // //         }
// // //     }
...
// // //         }
// // //         else{
// // //             memcpy(&v.u.roma_noop, payload, sizeof(payuel_roma_ResetRoute_tlm_payload_t));
// // //             return true;
// // //         }
// // //     }
...
// // //         }
// // //         else{
// // //             memcpy(&v.u.roma_noop, payload, sizeof(payuel_roma_LoadRoute_tlm_payload_t));
// // //             return true;
// // //         }
// // //     }
...
// // //         }
// // //         else{
// // //             memcpy(&v.u.roma_noop, payload, sizeof(payuel_roma_SaveRoute_tlm_payload_t));
// // //             return true;
// // //         }
// // //     }
...
// // //         }
// // //         else{
// // //             memcpy(&v.u.roma_noop, payload, sizeof(payuel_roma_SendRoute_tlm_payload_t));
// // //             return true;
// // //         }
// // //     }
...
// // //         }
// // //         else{
// // //             memcpy(&v.u.roma_noop, payload, sizeof(payuel_roma_ParGet_tlm_payload_t));
// // //             return true;
// // //         }
// // //     }
...
// // //         }
// // //         else{
// // //             memcpy(&v.u.roma_noop, payload, sizeof(payuel_roma_ParSet_tlm_payload_t));
// // //             return true;
// // //         }
// // //     }
...
// // //         }
// // //         else{
// // //             memcpy(&v.u.roma_noop, payload, sizeof(payuel_roma_ParDefaults_tlm_payload_t));
// // //             return true;
// // //         }
// // //     }
...
// // //         }
// // //         else{
// // //             memcpy(&v.u.roma_noop, payload, sizeof(payuel_roma_ParSave_tlm_payload_t));
// // //             return true;
// // //         }
// // //     }
...
// // //         }
// // //         else{
// // //             memcpy(&v.u.roma_noop, payload, sizeof(payuel_roma_ParRestore_tlm_payload_t));
// // //             return true;
// // //         }
// // //     }
...
// // //         }
// // //         else{
// // //             memcpy(&v.u.roma_noop, payload, sizeof(payuel_roma_ParLoad_tlm_payload_t));
// // //             return true;
// // //         }
// // //     }
...
// // //         }
// // //         else{
// // //             memcpy(&v.u.roma_noop, payload, sizeof(payuel_roma_ParSetOOB_tlm_payload_t));
// // //             return true;
// // //         }
// // //     }
...
// // //         }
// // //         else{
// // //             memcpy(&v.u.roma_noop, payload, sizeof(payuel_roma_SendCommand_tlm_payload_t));
// // //             return true;
// // //         }
// // //     }
...
// // //     sprintf(filename,
// // //             "../data/beacon/BEE1012Beacon--%04d-%02d-%02d-%02d-%02d-%02d--.txt",
// // //             local->tm_year + 1900, local->tm_mon + 1, local->tm_mday,
// // //             local->tm_hour, local->tm_min, local->tm_sec);
...
// // //     sprintf(filename,
// // //             "../data/beacon/UELYSYSBeacon--%04d-%02d-%02d-%02d-%02d-%02d--.txt",
// // //             local->tm_year + 1900, local->tm_mon + 1, local->tm_mday,
// // //             local->tm_hour, local->tm_min, local->tm_sec);
...
// // //             "../data/bcnpkt/BEE1012BeaconPkt--%04d-%02d-%02d-%02d-%02d-%02d--",
// // //             local->tm_year + 1900, local->tm_mon + 1, local->tm_mday,
// // //             local->tm_hour, local->tm_min, local->tm_sec);
...
// // //     sprintf(bcnpktfilename,
// // //             "../data/bcnpkt/UELYSYSBeaconPkt--%04d-%02d-%02d-%02d-%02d-%02d--",
// // //             local->tm_year + 1900, local->tm_mon + 1, local->tm_mday,
// // //             local->tm_hour, local->tm_min, local->tm_sec);
...
// // //                         double dt = difftime(now, g_report_last_chunk_time);
// // //                         if (dt > 5.0) {
// // //                             printf("case45: timeout dt=%.1f sec (>5). drop current report assembler.\n", dt);
...
// // //                     if (chunk_len > remain) {
// // //                         printf("case45: overflow (off=%zu, chunk=%zu). drop current and restart with this chunk.\n",
// // //                             g_report_off, chunk_len);
...
// // //                             if (ok) {
// // //                                 printf("\ncase45: REPORT COMPLETE \nMsgId=0x%04x \nRefMID=0x%04x \nCC=0x%02x \nRetSize=%u\n",
// // //                                     rpt.CCSDS_MsgId, rpt.ReflectedMID, rpt.ReflectedCC, (unsigned)rpt.RetValSize);
// // //                                 UpdateReportViewFromReport(rpt);
// // //                                 ReportSaver(&rpt);
// // //                             } else {
// // //                                 printf("case45: ParseReportWire540 failed\n");
// // //                             }
...
// // //                         }
// // //                     } else {
// // //                         printf("case45: chunk too big to fit even after restart (%zu)\n", chunk_len);
// // //                     }
...
// // //                         double dt = difftime(now, g_report_last_chunk_time);
// // //                         if (dt > 5.0) {
// // //                             printf("case40: timeout dt=%.1f sec (>5). drop current report assembler.\n", dt);
...
// // //                     if (chunk_len > remain) {
// // //                         printf("case40: overflow (off=%zu, chunk=%zu). drop current and restart with this chunk.\n",
// // //                             g_report_off, chunk_len);
...
// // //                             if (ok) {
// // //                                 printf("\ncase40: REPORT COMPLETE \nMsgId=0x%04x \nRefMID=0x%04x \nCC=0x%02x \nRetSize=%u\n",
// // //                                     rpt.CCSDS_MsgId, rpt.ReflectedMID, rpt.ReflectedCC, (unsigned)rpt.RetValSize);
// // //                                 UpdateReportViewFromReport(rpt);
// // //                                 ReportSaver(&rpt);
// // //                             } else {
// // //                                 printf("case40: ParseReportWire540 failed\n");
// // //                             }
...
// // //                         }
// // //                     } else {
// // //                         printf("case40: chunk too big to fit even after restart (%zu)\n", chunk_len);
// // //                     }
...
// //     if ((uint32_t)EPS_QUERY_REPORT_HEADER_SIZE + meta.chunk_size > payload_len) {
// //         return false;
// //     }
...
// //     if (v.reflected_cc == EPS_GET_HK_ALL_CC &&
...
// //     if (rpt->ReflectedCC == EPS_GET_HK_ALL_CC &&
// //         meta.data_id == EPS_QUERY_REPORT_P80_PMU_HK &&
// //         meta.source == 1 &&
...
// //     fprintf(fp, "\n[EPS] Unknown query result CC=%" PRIu8 " source=%" PRIu8 " data_id=%" PRIu8 "\n",
// //             rpt->ReflectedCC, meta.source, meta.data_id);
// //     return false;
// // }
            ...
            if (v.reflected_cc == EPS_RPARAM_GET_FULL_TABLE_CC &&
                ...
                for (uint16_t i = 0; i < m.chunk_size; ++i) {
                    ...
                    if (s.coverage[pos]) {
                        ...
                        if (s.buffer[pos] != v.u.uelysys.bytes[i]) s.error = true;
                    } else {
                        s.coverage[pos] = 1;
                        ++s.received_size;
                    }
                    s.buffer[pos] = v.u.uelysys.bytes[i];
                }
                s.complete = s.received_size == s.total_size;
                s.valid = !s.error;
            }
            break;
...
static bool DecodePayloadToView(ReportView_t &v, const uint8_t *payload, uint16_t payload_len) {
    ...
    if (v.kind == REPORT_KIND_UELYSYS_UTRX) {
        if (v.reflected_cc == UELYSYS_UTRX_RXCONF_GET_BAUD_CC) {
    ...
    if (v.kind == REPORT_KIND_UELYSYS_AOS) {
        if (v.reflected_cc == UELYSYS_PAYUEL_AOS_READ_REGISTER_CC) {
...
static void DumpUelysysReportParsed(FILE *fp, const Report *rpt)
{
    ...
    if (rpt->ReflectedMID == UELYSYS_MEOW_CMD_ID || rpt->ReflectedMID == 0x8618)
    {
        fprintf(fp, "\n[UELYSYS MEOW]\n");
    ...
    if (rpt->ReflectedMID == UELYSYS_UTRX_CMD_ID || rpt->ReflectedMID == 0x5018) {
        fprintf(fp, "\n[UELYSYS UTRX]\n");
        if (rpt->ReflectedCC == UELYSYS_UTRX_RXCONF_GET_BAUD_CC && n == sizeof(UELYSYS_UTRX_RxBaud_Report_t)) {
    ...
    if (rpt->ReflectedMID == UELYSYS_PAYUEL_AOS_CMD_ID || rpt->ReflectedMID == 0x4718) {
        fprintf(fp, "\n[UELYSYS PAYUEL AOS]\n");
        if (rpt->ReflectedCC == UELYSYS_PAYUEL_AOS_READ_REGISTER_CC &&
        ...
        } else if ((rpt->ReflectedCC == UELYSYS_PAYUEL_AOS_NOOP_CC ||
                    rpt->ReflectedCC == UELYSYS_PAYUEL_AOS_RESET_CC ||
